...
The maximum `r section.label` difference of `r d.diff$Diff[diffidx]` 
occurred at Station `r d.diff$Station[diffidx]` on 
`r d.diff$Time[diffidx]`. The largest total RMSE at a single time 
was `r d.rmse.time$RMSE[tidx]` on `r d.rmse.time$Time[tidx]`. The 
largest total RMSE at a single station was 
`r d.rmse.station$RMSE[sidx]` at `r d.rmse.station$Station[sidx]`.
